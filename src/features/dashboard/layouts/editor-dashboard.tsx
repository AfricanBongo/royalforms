...
import { AssignedFieldsList } from '../components/assigned-fields-list'
...
export function EditorDashboard({ data }: EditorDashboardProps) {
  return (
    <div className="flex flex-col gap-4">
      ...
      {/* Row 2: Trend chart (bar) + Assigned fields */}
      <div className="grid grid-cols-1 gap-4 lg:grid-cols-12">
        ...
        <div className="lg:col-span-4">
          <AssignedFieldsList
            groups={data.assignedFields?.data}
            isLoading={data.assignedFields?.isLoading ?? false}
          />
        </div>
      </div>
